...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Member',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('320c266c-7178-11e9-aaa3-acde48001122'), editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '微信用户资料(服务于订单)',
            },
        ),
    ]
